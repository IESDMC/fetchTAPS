def fetchResponse(args):
    ...
    url = requestResponse(format, tb, te, proj, net, sta, loc, cha, label, JWT)
    if url == None:
        return
    # check order
        # developing
...
if __name__ == '__main__':
    ...
    epilog='Example: python fetchResponse.py -u chute@earth.sinica.edu.tw -p 27839910#2705 -format pz -tb 2008-02-17T20:31:00 -te 2008-02-17T20:41:00 -proj 2008NSN,2008NSS -net TW -sta all -loc all -cha HHZ -label 20080217203100')
    parser.add_argument('-format', metavar='format', type=str, nargs='+',
                        help='-format pz', dest='format', required=True)
